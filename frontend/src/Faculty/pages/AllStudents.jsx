...
const AllStudents = () => {
  ...
  const getStatusBadge = (status) => {
    ...
    return (
      <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium ${styles[status] || 'bg-gray-100 text-gray-800'}`}>
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <main className="flex-grow max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">View all students who have applied to your projects</p>
        </div>
        ...
        <div className="mb-6">
          ...
          {searchTerm && (
            <p className="mt-2 text-sm text-gray-600">
              Found <span className="font-semibold">{filteredApplications.length}</span> application{filteredApplications.length !== 1 ? 's' : ''}
            </p>
          )}
        </div>
          ...
          {isLoading ? (
            ...
            <div className="p-12 text-center">
              ...
              <h3 className="mt-2 text-sm font-medium text-gray-900">
                {searchTerm ? 'No matching students' : 'No applications yet'}
              </h3>
